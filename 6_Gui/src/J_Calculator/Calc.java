...
public class Calc implements ActionListener {
    ...
    JButton addButton, subButton, multButton, divButton, equButton, decButton, delButton, clrButton, negButton;
    JPanel panel;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == delButton) {
            ...
            for (int i = 0; i < numString.length() - 1; i++) {
                textField.setText(textField.getText() + numString.charAt(i));
            }
