...
public class Tes {
    ...
    public static class Treee {
        ...
        public boolean equals(Treee other) {
            if (other == null)
                return false;
        ...
        public  ArrayList<Integer> toArrayList(){
            ...
            return toArrayList(root,list);
        }
        public  ArrayList<Integer> toArrayList(Node node,ArrayList<Integer> list){
            if (isLeaf(node))
               list.add(node.value);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("contains -->   " +tree.contains(33));
